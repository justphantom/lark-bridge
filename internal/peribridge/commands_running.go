...
// runningSession represents a currently active peri turn.
...
// cmdRunning lists all currently active peri turns across all chats.
...
// It snapshots (chatID, *promptCancel) under cancelMu, then releases the lock
// before querying the router.
...
// formatRunningSessions renders the running turns list.
...
// formatDuration formats a duration with Chinese unit suffixes.
