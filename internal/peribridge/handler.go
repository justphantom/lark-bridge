...
type Handler struct {
	...
	// currently unused: peri takes its working dir from the /cd pin or an event
	// override (see ensureBinding), never auto-derived. Retained for config
	// parity with the claude bridge.
