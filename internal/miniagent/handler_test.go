...
func TestHandleEvent_EmitsResultOnSuccess(t *testing.T) {
	...
	rpc := &captureSender{}
	h := New(llm, LoopConfig{Model: "m"}, rpc, log.Nop(), nil, "", nil, "default")
...
func TestHandleEvent_EmitsStepsOnResult(t *testing.T) {
	...
	rpc := &captureSender{}
	h := New(llm, LoopConfig{Model: "m", Tools: []Tool{tool}}, rpc, log.Nop(), nil, "", nil, "default")
...
func TestHandleEvent_EmitsErrorOnLLMFailure(t *testing.T) {
	...
	rpc := &captureSender{}
	h := New(llm, LoopConfig{}, rpc, log.Nop(), nil, "", nil, "default")
...
func TestHandleEvent_NonPromptIgnored(t *testing.T) {
	h := New(&fakeLLM{}, LoopConfig{}, &captureSender{}, log.Nop(), nil, "", nil, "default")
...
func TestHandleEvent_DistinctChatsConcurrent(t *testing.T) {
	llm1 := newSlowLLM()
	rpc := &captureSender{}
	h := New(llm1, LoopConfig{Model: "m"}, rpc, log.Nop(), nil, "", nil, "default")
...
func TestAbort_IdleReply(t *testing.T) {
	rpc := &captureSender{}
	h := New(&fakeLLM{}, LoopConfig{Model: "m"}, rpc, log.Nop(), nil, "", nil, "default")
