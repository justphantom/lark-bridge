...
// Per-chat pins (Model / Directory / Permission) live in pins.go: each has a
// Get / Set pair backed by a .model / .dir / .perm file, all sharing the
// readPin / writePin helpers there.
