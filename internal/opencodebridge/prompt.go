...
// each to a "> ..." blockquote so the user can optionally expand the
// reasoning without it dominating the answer. Stray unmatched <think> tags
// (truncated stream) are dropped.
