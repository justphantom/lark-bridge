...
// runningSession represents a currently active opencode session.
...
// cmdRunning lists all currently active opencode sessions across all chats.
// This helps users understand system load and identify stuck or long-running
// sessions.
