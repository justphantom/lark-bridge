...
// snapshot copies the recorded fields under the lock for assertions.
...
// newGitTestHandler builds a Handler with a fresh router and an injected
// fake GitRunner, so cmdPull/cmdPush can be tested without shelling out.
