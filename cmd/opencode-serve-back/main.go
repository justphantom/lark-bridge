...
func run(cfgPath string) error {
	...
	usageStore, err := usage.New(filepath.Join(cfg.StateDir, "usage-opencode-serve.json"), componentLogger(cfg, baseLevel, output, "usage"), time.Duration(cfg.Timeouts.UsageSessionTTL))
	if err != nil {
